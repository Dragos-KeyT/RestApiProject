...
public class JsonPathExample extends BaseComponent2 {
	...
	public void getAllUsers() {
		...
		System.out.println("get by index " +jsonPath.getString("users[1]"));
		...
		List<String> allNames = jsonPath.getList("users.findAll{it.name == 'Fritz' | it.name == 'nimic'}");
		...
		///System.out.println(ageLessThan.get(0).toString());
